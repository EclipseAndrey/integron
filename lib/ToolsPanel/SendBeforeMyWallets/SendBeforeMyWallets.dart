...
import 'package:omega_qick/ToolsPanel/SendBeforeMyWallets/ButtonSend.dart';
import 'package:omega_qick/ToolsPanel/SendBeforeMyWallets/SelectWalletBottomSheet.dart';
import 'dart:math' as math;

import 'FieldSumm.dart';

class SendBeforeMyWallets extends StatefulWidget {
  List<User> wallets;
  List<AddressA> adresses;

  SendBeforeMyWallets(this.wallets, this.adresses);

  @override
  _SendBeforeMyWalletsState createState() => _SendBeforeMyWalletsState();
}

class _SendBeforeMyWalletsState extends State<SendBeforeMyWallets> {
  User walletS = null;
  User walletZ = null;
      ...
      child: Column(
        children: [
          ...
          buttonSendDel(widget.adresses, walletS,
              walletZ, context, controllerSumm),
        ],
      ),
    );
  }
