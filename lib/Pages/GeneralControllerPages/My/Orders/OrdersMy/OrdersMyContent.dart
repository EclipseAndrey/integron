...
class OrdersMyContent extends StatefulWidget {
  ...
  OrdersMyContent({ this.stateCallback, this.orders});


  @override
  _OrdersMyContentState createState() => _OrdersMyContentState();
}

class _OrdersMyContentState extends State<OrdersMyContent> {
