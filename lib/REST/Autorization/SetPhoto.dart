...
Future<int> setPhoto (String photo)async{
  String token = await tokenDB();
  String urlQuery = server14880+ "/api.php/setphoto?photo=$photo&token=$token"; //http://194.226.171.139:14880/apitest.php/setaddress?address=
  print(urlQuery);
  var response;
  try{
