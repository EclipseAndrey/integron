...
Future<int> setBizName (String name)async{
  String token = await tokenDB();
  String urlQuery = server14880+ "/api.php/setbizname?name=$name&token=$token"; //http://194.226.171.139:14880/apitest.php/setaddress?address=
  print(urlQuery);
  var response;
  try{
  ...
  print("setBizName "+response.body);
